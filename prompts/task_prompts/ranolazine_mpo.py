...
- detailed ranolazine_mpo score:
  - logP: {logp} # THIS SHOULD BE AROUND 7
  - TPSA: {tpsa} # THIS SHOULD BE AROUND 95
  - number of fluorine atoms: {num_fluorine} # THIS SHOULD BE AROUND 1
  - Tanimoto similarity score: {similarity} # THIS SHOULD BE AROUND 0.7
...
- Detailed ranolazine_mpo score:
  ...
  - TPSA: {tpsa} # THIS SHOULD BE AROUND 95
  - number of fluorine atoms: {num_fluorine} # THIS SHOULD BE AROUND 1
  - Tanimoto similarity score: {similarity} # THIS SHOULD BE AROUND 1
