...
# Load CSV file
csv_path = "/home/khm/chemiloop/dataset/10k_rndm_zinc_drugs_clean_3.csv"
...
# Save to JSON
json_path = "./dataset/entire_zinc10.json"
with open(json_path, "w") as f:
    json.dump(output_data, f, indent=2)

print(f"\nSaved {len(output_data)} entries to {json_path}")
