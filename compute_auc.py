...
# ---------------------------
def compute_topk_auc_from_file(file_path, top_k=5, max_oracle_calls=1000, freq_log=1, run_name='', project='', task=''):
    smiles_scores = []
...
if __name__ == "__main__":
    ...
    for object in score_list:
        project, task, auc = object
        print(f"Project: {project}, Task: {task}, AUC: {auc:.4f}")